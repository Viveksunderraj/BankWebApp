...
@WebServlet("/TransferWithinBankController")
public class TransferWithinBankController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("TransferWithinBank.jsp?message=" + URLEncoder.encode(message, "UTF-8"));
	}
